...
export default function PaymentReceipt({
  ...
  return (
    <div className="fixed inset-0 z-[60] overflow-y-auto bg-gray-900/80 backdrop-blur-sm p-4 print:block print:bg-white print:p-0">
      <div className="flex min-h-full items-center justify-center">
        <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl relative max-h-[90vh] flex flex-col print:shadow-none print:w-full print:max-w-none print:rounded-none print:max-h-none">
          ...
          <div className="bg-gray-100 px-6 py-4 flex justify-between items-center shrink-0 print:hidden border-b border-gray-200">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-4 py-2 bg-gray-900 hover:bg-black text-white text-sm font-bold rounded-lg flex items-center gap-2"
              >
          ...
          <div className="overflow-y-auto flex-1 print:overflow-visible">
            ...
            <div className="p-10 md:p-14 bg-white print:p-8">
              ...
              <div className="text-center mb-8 border-b-2 border-gray-100 pb-8">
                <h1 className="text-3xl font-black text-[#1F3864] font-serif uppercase tracking-tight">
                  Grand Alnoor
                </h1>

                <p className="text-gray-500 text-sm mt-1">
                  Marquee & Banquet Hall • Sahiwal, Punjab
                </p>
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 mb-8 flex justify-between items-center">
                <div>
                  ...
                  <p
                    className={`text-4xl font-black font-serif ${
                      isRefund ? 'text-red-600' : 'text-[#1F3864]'
                    }`}
                  >
                ...
                <div className="text-right space-y-1">
                  ...
                  <p className="text-xs text-gray-600">
                    ...
                    {receipt.received_by || 'Not specified'}
                  </p>
                </div>
              </div>
