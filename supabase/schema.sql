...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    time_slot VARCHAR(50) NOT NULL CHECK (time_slot IN ('Day', 'Evening', 'Full Day')),
    event_type VARCHAR(50) NOT NULL CHECK (event_type IN ('Wedding', 'Walima', 'Engagement', 'Mehndi', 'Corporate')),
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    payment_method VARCHAR(50) NOT NULL CHECK (payment_method IN ('Cash', 'Bank Transfer', 'Cheque', 'Other')),
    payment_type VARCHAR(50) NOT NULL CHECK (payment_type IN ('Advance', 'Installment', 'Final Payment', 'Refund')),
